                            ...
                            <div class="card-header">
                                ...
                                {{-- <div class="section-header-button">
                                    <a href="{{route('user.create')}}"
                                        class="btn btn-primary">Add New Users</a>
                                </div> --}}
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table">
                                        {{-- make schedules table for this column $table->foreignId('subject_id')->constrained('subjects');
                                            $table->string('hari');
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{route('generate-qrcode', $schedule->id)}}"
                                                            class="btn btn-primary">Generate QR</a>
                                                    </td>
                                                    <td>
